...
return [
    ...
    'Title' => 'Заголовок',
    'Name' => 'Имя',
    'Name and Last name' => 'Имя, Фамилия',
    'Text' => 'Текст',
    'Date' => 'Дата',
    'Slug' => 'Метка',
    'Tags' => 'Список тэгов',
    ...
    'Data saved successfully' => 'Данные сохранены успешно',
    ...
    'Follow the link below to reset your password:' => 'Перейдите по приведенной ниже ссылке, чтобы сбросить пароль:',
    'Enter email to reset password' => 'Введите email для восстановления пароля',
    'There is no user with such email' => 'Пользователя c введённым email не найдено',
    'Please choose your new password' => 'Введите новый пароль',
    'New password saved successfully' => 'Новый пароль сохранен успешно',
    'Check your email and follow the instructions' => 'Проверьте свою электронную почту и следуйте инструкциям',
    'Hello' => 'Здравствуйте',
    ...
    'Email for messages from the site' => 'Емайл для сообщений с сайта',
    'Email already exists' => 'Емайл уже существует, выберите другой',

    'Picture size for preview in the gallery' => 'Размер картинок для предварительного просмотра в галерее',
    'Dimensions of slides in the carousel' => 'Размеры слайдов в карусели',
    'Size of the images in the annotations of the articles' => 'Размер изображений в аннотациях статей',
