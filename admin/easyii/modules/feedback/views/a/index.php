    ...
    <table class="table table-hover">
        ...
        <?php foreach ($data->models as $item) : ?>
            <tr>
                ...
                <?php endif; ?>
                <td>
                    <a href="<?= Url::to(['/admin/' . $module . '/a/view', 'id' => $item->primaryKey]) ?>"><?= ($this->context->module->settings['enableTitle'] && $item->title != '') ? $item->title : StringHelper::truncate($item->text, 64, '...') ?></a>
                </td>
