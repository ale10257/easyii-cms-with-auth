...
<ul class="nav nav-pills">
    ...
    <li class="pull-right">
        <?php if ($action === 'view') : ?>
            <a href="<?= Url::to(['/admin/' . $module . '/a/setnew', 'id' => Yii::$app->request->get('id')]) ?>"
               class="text-warning"><span
                        class="glyphicon glyphicon-eye-close"></span> <?= Yii::t('easyii/guestbook', 'Mark as new') ?>
            </a>
        <?php else : ?>
            <a href="<?= Url::to(['/admin/' . $module . '/a/viewall']) ?>" class="text-warning"><span
                        class="glyphicon glyphicon-eye-open"></span> <?= Yii::t('easyii/guestbook', 'Mark all as viewed') ?>
            </a>
        <?php endif; ?>
    </li>
</ul>
