...
<div id="admin-body">
    <div class="container">
        <div class="wrapper">
            <div class="header">
                <div class="logo">
                    <a style="color: #FFF;font-weight: bold;" href="/admin"><img src="<?= $asset->baseUrl ?>/img/logo_20.png">
                    EasyiiCMS</a>
                </div>
                <div class="nav">
                    <a target="_blank" href="<?= Yii::$app->homeUrl ?>" class="pull-left"><i
                                class="glyphicon glyphicon-home"></i> <?= Yii::t('easyii', 'Open site') ?></a>
                    <a href="<?= Url::to(['/admin/sign/out']) ?>" class="pull-right"><i
                                class="glyphicon glyphicon-log-out"></i> <?= Yii::t('easyii', 'Logout') ?></a>
                </div>
            </div>
            <div class="main">
